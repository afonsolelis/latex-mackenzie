...
\begin{description}
\item[API] \textit{Application Programming Interface} - Interface de Programação de Aplicações. Conjunto de definições e protocolos usados para desenvolver e integrar software de aplicações.
