\documentclass[12pt, a4paper, oneside, brazilian]{abntex2}
...
\titulo{Modelo de Gêmeo Digital de Processos e Sistemas para Avaliações em Project Based Learning}
\autor{Afonso Cesar Lelis Brandão}
\orientador{Dr. Ismar Frango Silveira}
\instituicao{%
...
\preambulo{Projeto de Pesquisa apresentado ao Programa de Pós-Graduação em Engenharia Elétrica e Computação da Universidade Presbiteriana Mackenzie como parte dos requisitos para qualificação no programa de doutorado.}
\local{São Paulo}
\data{2025}
% ---
