...
\heading{Autor 1; Autor 2}{RBIE v.33 -- 2025}

\citeas{Autor 1; Autor 2 (2025). Modelo de Gêmeo Digital Híbrido para Avaliação Multidimensional em Project-Based Learning: Uma Abordagem Integrada de Processos e Sistemas. Revista Brasileira de Informática na Educação, 33, 1--17. https://doi.org/10.5753/rbie.2025.3301}
...
\begin{otherlanguage}{english}
  ...
  \begin{abstract}
    Assessment in Project-Based Learning (PBL) represents a significant challenge for higher education institutions, particularly in software engineering where learning processes are inherently multidimensional and demand continuous monitoring. This paper proposes a hybrid digital twin model that seamlessly integrates process and system twins, enabling real-time monitoring and assessment of PBL projects. The model establishes its foundation on multiple complementary architectural views -- structural, behavioral, and process --, following ISO/IEC/IEEE 42010:2022 principles for defining viewpoints and views according to stakeholder concerns which facilitate comprehensive multidimensional analysis across pedagogical, technical, and management domains. The approach operates through automated data collection from version control repositories, educational management systems, advisor-student interactions, and project documentation, employing advanced natural language processing algorithms and educational data mining techniques to extract meaningful insights regarding learning progression. Conceptual validation demonstrates significant potential for early identification of learning difficulties, reduction of assessment subjectivity, and substantial improvement in pedagogical feedback quality compared to traditional punctual assessment methods.
...
\begin{otherlanguage}{spanish}
  ...
  \begin{abstract}
    La evaluación en Aprendizaje Basado en Proyectos (ABP) representa un desafío significativo para las instituciones de educación superior, especialmente en ingeniería de software, donde los procesos de aprendizaje son intrínsecamente multidimensionales y demandan monitoreo continuo. Este artículo propone un modelo de gemelo digital híbrido que integra de manera fluida gemelos de proceso y sistema, posibilitando el monitoreo y evaluación en tiempo real de proyectos ABP. El modelo establece su fundamento en múltiples vistas arquitectónicas complementarias -- estructural, conductual y de proceso --, siguiendo los principios de ISO/IEC/IEEE 42010:2022 para definir puntos de vista y vistas según las preocupaciones de las partes interesadas que facilitan un análisis multidimensional integral abarcando dominios pedagógicos, técnicos y de gestión. El enfoque opera mediante recopilación automatizada de datos provenientes de repositorios de control de versiones, sistemas de gestión educativa, interacciones asesor-estudiante y documentación de proyectos, empleando algoritmos avanzados de procesamiento de lenguaje natural y técnicas de minería de datos educativos para extraer conocimientos significativos sobre la progresión del aprendizaje. La validación conceptual demuestra un potencial considerable para la identificación temprana de dificultades de aprendizaje, reducción de la subjetividad evaluativa y mejora sustancial en la calidad del feedback pedagógico en comparación con métodos de evaluación puntuales tradicionales.
...
A Aprendizagem Baseada em Projetos (PBL) consolidou-se como uma abordagem
educacional ativa, promovendo o desenvolvimento de competências por meio da
integração entre teoria e prática, resolução de problemas reais e trabalho
colaborativo~(Zhang et al., 2023; Khuankrue \& Wongwanich, 2017). Sua adoção em
áreas como ciências, saúde, tecnologia e, especialmente, engenharia, reflete o
potencial do PBL em aproximar o processo formativo das demandas do mundo
profissional.
